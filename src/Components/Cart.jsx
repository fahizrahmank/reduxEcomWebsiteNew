  ...
  return (
    ...
    {cartProducts.map((product) => (
      ...
      <section className="h-100 h-custom" style={{ backgroundColor: "#eee" }}>
        <MDBContainer className="h-70 py-5" >
          <MDBRow className="justify-content-center align-items-center h-70">
            <MDBCol>
                  ...
                  <MDBRow >
                    <MDBCol lg="7" className="px-5 py-4">
                      ...
                      <div className="d-flex align-items-center mb-5">
                        ...
                        <a  className="float-end text-black" onClick={() => removeproduct(product.id)}>
